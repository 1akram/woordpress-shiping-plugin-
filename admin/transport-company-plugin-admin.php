...
class Transportation_Company_Admin
{
	...
	public function addAdminMenuItems()
	{
		...
		// Add a submenu
		add_submenu_page(
			'transportation-companies',           // Parent slug
			'New company',            // Page title
			'New company',            // Menu title
			'manage_options',      // Capability required to access this submenu
			'my-plugin-settings',  // Slug of the submenu
			array($this, 'my_plugin_settings_page'), // Callback function to render the submenu page
			2
		);
	}
